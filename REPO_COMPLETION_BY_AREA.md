...
(93 + 88 + 87 + 86 + 92 + 97 + 93 + 82 + 98 + 90 + 76 + 35) ÷ 12 = 1030 ÷ 12 ≈ **85.8%**.

So the rough figure is **~86%** toward a hypothetical “full statistics stack with universal parity.” That target is **not** the project goal—[`README.md`](README.md) describes the crate as usable with **documented**, narrower scope than the full R ecosystem.
