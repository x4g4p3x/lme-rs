...
| Integration tests | **52** Rust modules under [`tests/`](tests/) excluding the consolidated harness (including `test_nlmm_orange.rs`, `test_mcp.rs`, `test_r_edge_case_matrix.rs`, `test_explorations.rs`; counted 2026-08-14) |
