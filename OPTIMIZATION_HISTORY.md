# Optimization experiment archive

> **Historical evidence, archived 2026-09-11.** The following notes preserve
> implementation experiments, rejected approaches, and dated timings. They are
> not a description of every current execution path. Start with the
> [current engineering guide](OPTIMIZATION.md) and [benchmark results](BENCHMARKS.md).
