...
- Likelihood ratio tests between nested models, Type I / II / III fixed-effects ANOVA (1-DoF tests for continuous terms; joint multi-DoF Wald tests for grouped categorical fixed effects), Tukey / Dunnett multiple comparisons (`glht`), and LMM estimated marginal means (`emmeans`) with reference-grid pairwise contrasts
