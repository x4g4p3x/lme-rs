...
| GLMM, CBPP cloglog / Gamma dyestuff | Manifest `cbpp_binomial_cloglog`, `gamma_dyestuff_log_laplace` | Non-canonical cloglog link; Gamma log-link mean/dispersion (RE θ not asserted for Gamma). |
